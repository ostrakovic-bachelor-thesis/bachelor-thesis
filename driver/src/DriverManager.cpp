...
{
  [static_cast<uint8_t>(USARTInstance::USART1)]  = USART(reinterpret_cast<USART_TypeDef*>(Peripheral::USART1), nullptr),
  [static_cast<uint8_t>(USARTInstance::USART2)]  = USART(reinterpret_cast<USART_TypeDef*>(Peripheral::USART2), nullptr),
  [static_cast<uint8_t>(USARTInstance::USART3)]  = USART(reinterpret_cast<USART_TypeDef*>(Peripheral::USART3), nullptr),
  [static_cast<uint8_t>(USARTInstance::UART4)]   = USART(reinterpret_cast<USART_TypeDef*>(Peripheral::UART4), nullptr),
  [static_cast<uint8_t>(USARTInstance::UART5)]   = USART(reinterpret_cast<USART_TypeDef*>(Peripheral::UART4), nullptr),
  [static_cast<uint8_t>(USARTInstance::LPUART1)] = USART(reinterpret_cast<USART_TypeDef*>(Peripheral::LPUART1), nullptr)
};