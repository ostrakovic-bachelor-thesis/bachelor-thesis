...
const ResetControl::EnablePeripheralClockRegisterMapping ResetControl::s_enablePeripheralClockMapping[] =
{
  ...
  { .peripheral = Peripheral::I2C1, .enableRegister = Register::APB1ENR1, .enableBitPosition = 21u },
  { .peripheral = Peripheral::I2C2, .enableRegister = Register::APB1ENR1, .enableBitPosition = 22u },
  ...
  { .peripheral = Peripheral::LTDC, .enableRegister = Register::APB2ENR, .enableBitPosition = 26u },

  { .peripheral = Peripheral::DSIHOST, .enableRegister = Register::APB2ENR, .enableBitPosition = 27u },
};
